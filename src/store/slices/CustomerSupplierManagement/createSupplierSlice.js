...
import { CreateSupplier } from '../../../Services/ProductServices';
...
export const createSupplierAction = createAsyncThunk('createSupplierAction', async ({ data, navigate }, thunkApi) => {
