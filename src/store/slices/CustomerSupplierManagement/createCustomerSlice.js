...
import { CreateCustomer } from '../../../Services/ProductServices';
...
export const createCustomerAction = createAsyncThunk('createCustomerAction', async ({ data, navigate }, thunkApi) => {
